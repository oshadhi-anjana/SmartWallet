      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.titleRow}>
            ...
            <Pressable style={styles.addButton} onPress={startAdd} accessibilityLabel="Add savings goal"><Ionicons name="add" size={23} color="#FFFFFF" /></Pressable>
          </View>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryTrack}><View style={[styles.summaryFill, { width: `${totals.target ? Math.min(totals.saved / totals.target * 100, 100) : 0}%` }]} /></View>
          </View>
          ...
          {goals.length === 0 ? (
            <View style={styles.emptyCard}>
              <View style={styles.emptyIcon}><Ionicons name="flag-outline" size={31} color="#0F9D58" /></View>
              ...
              <Pressable style={styles.emptyButton} onPress={startAdd}><Ionicons name="add" size={18} color="#FFFFFF" /><ThemedText type="smallBold" style={styles.white}>Create goal</ThemedText></Pressable>
            </View>
          ) : goals.map((goal) => {
            ...
            return (
              <View style={styles.goalCard} key={goal.id}>
                <View style={styles.goalHeader}>
                  <View style={styles.goalIcon}><Ionicons name="flag-outline" size={22} color="#0F9D58" /></View>
                  ...
                  <ThemedText type="smallBold" style={styles.percent}>{(progress * 100).toFixed(0)}%</ThemedText>
                </View>
                <View style={styles.amountRow}><ThemedText style={styles.savedAmount}>{money(goal.currentAmount)} saved</ThemedText><ThemedText themeColor="textSecondary" style={styles.targetAmount}>of {money(goal.targetAmount)}</ThemedText></View>
          ...
          <Pressable style={styles.backdrop} onPress={resetForm}>
            <Pressable style={styles.formModal} onPress={(event) => event.stopPropagation()}>
              ...
              <ScrollView contentContainerStyle={styles.formContent} keyboardShouldPersistTaps="handled" automaticallyAdjustKeyboardInsets>
                ...
                <Pressable style={styles.primaryButton} onPress={saveGoal}><ThemedText type="smallBold" style={styles.white}>{editingGoal ? 'Update goal' : 'Create goal'}</ThemedText></Pressable>
              </ScrollView>
            </Pressable>
          </Pressable>
        </Modal>
